                            ...
                            <div class="row">
                                ...
                                @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="title" class="form-control" value="{{$response->data->title}}" required>

                                            <input type = "hidden" value="{{$response->data->section_id}}" name="section_id" />
                                    ...
                                    <input type = "hidden" value="{{$video->video_id}}" name="videos[]" />
                                    <div class="card">
                    <div class="card-body">
                        <div class="row"> 
            
                            <div class="col-md-6">
                                        <img src=" {{$video->banner}}" width="200">
                            </div>

                            <div class="col-md-6">
                                <h5>Title: {{$video->title}}</h5><br />
                                <h5>Category: {{$video->category}}</h5><br />

                                <button id="${{$video->video_id}}" class="removeFromStaging btn btn-danger">Remove from Section</button>
