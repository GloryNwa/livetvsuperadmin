...
<div class="media media-4x3"><a  class="ajax media-content"
  style="background-image:url(/assets/img/z7.jpg)"></a>
<div class="media-action"></div>
</div>
<div class="list-content p-5">
<div class="list-body"><a class="list-title title ajax h4 font-weight-bold">Amazing
songs </a></div>
</div>
</div>
</div>
...
<h5 class="text-highlight sr-item">Manage Banners</h5></div>
...
<div class="media">{{$banner->description}}<a class="ajax media-content"style="background-image:url('{{$banner->file}}')"></a>
<div class="media-action media-action-overlay">
<button class="btn btn-icon no-bg no-shadow hide-row" data-toggle-class><i data-feather="heart" class="active-danger"></i></button>
...
<div class="list-body"><a href="playlist_detail.php#92570808">
  {{$banner->link}}
<a hreh=""><button class="btn btn-primary btn-xs">edit</button></a>
</div>
@endforeach
</div>
</div>
