...
<div class="page-title"><h2 class="text-md text-highlight">Video Blade</h2>
                  ...
                  <i class="material-icons"></i>
                   ...
                   <div class="card-body">
                    ...
                    <thead>
                      ...
                      <tbody>
                      <?php $x = 1;?>
                      @foreach($videos->data as $vid)
                    
                         <tr> 
                         <td>{{$x++}}</td>    
                          <td><div><a href="">
                                <div class="media" style="width: 100px; height: 60px;"><a href=""class="ajax media-content" style="background-image:url('{{$vid->banner}}')" data-pjax-state=""></a><div class="media-action media-action-overlay"></a>
...
<script src="/assets/js/site.min.js"></script>
  ...
  <script src="/assets1/js/material-dashboard.minf066.js?v=2.1.0" type="text/javascript"></script>
